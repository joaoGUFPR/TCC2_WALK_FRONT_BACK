...
class ComentarioPasseioAdapter(
    val comentarios: List<ComentarioPasseioComunidade>,
    private val context: Context,
    private val click: (comentario: ComentarioPasseioComunidade, position: Int) -> Unit,
    private val deleteClick: (comentario: ComentarioPasseioComunidade, position: Int) -> Unit,
    private val imageClick: (passeio: ComentarioPasseioComunidade, position: Int) -> Unit
) : RecyclerView.Adapter<ComentarioPasseioAdapter.ComentarioPasseioViewHolder>() {
    ...
    // Variável para armazenar a URL da imagem do usuário atual
    var currentUserImageUrl: String? = null

    override fun getItemId(position: Int): Long {
        return comentarios[position].idComentarioPasseio?.toLong() ?: position.toLong()
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ComentarioPasseioViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.list_item_comentario_comunidade, parent, false)
        return ComentarioPasseioViewHolder(view)
    }

    override fun getItemCount(): Int = comentarios.size

    override fun onBindViewHolder(holder: ComentarioPasseioViewHolder, position: Int) {
    ...
    inner class ComentarioPasseioViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val comentarioImagem: ImageView = itemView.findViewById(R.id.iVPerfilComentario)

        fun bind(comentario: ComentarioPasseioComunidade, isSelected: Boolean) {
            ...
            // Se o comentário tiver uma imagem definida, use-a; caso contrário, use a imagem do usuário atual
        ...
        private fun showPopupMenu(view: View, comentario: ComentarioPasseioComunidade) {
        ...
        fun getItemDetails(): ItemDetailsLookup.ItemDetails<Long> =
            object : ItemDetailsLookup.ItemDetails<Long>() {
                ...
                override fun getSelectionKey(): Long? = this@ComentarioPasseioAdapter.getItemId(adapterPosition)
            }
    }
}
